  ...
  const DATA = {
    ...
    names: {
      ...
      last: ['Pine','Socks','Pants','Waffle','Biscuit','Nugget','Toes','Beans','Muffin','Snout',
        ...
        'Snork','Noodle','Pickles','Fluff','Zoomies','Tacos','Sparklepants','Thunderpaws'],
    },
    ...
    lines: {
      welcome: [
        ...
        { id: 'welcome_6', speaker: 'bean',  text: "[excited] Welcome back to BEAN QUIZ! Tonight's episode: 'Everyone Is Smarter Than They Look.' [whispers] Except Tiger. He's exactly as smart as he looks." },
        { id: 'welcome_7', speaker: 'tiger', text: "[deadpan] I heard that. I hear everything. I have ears like satellite dishes and grudges like a filing cabinet." },
        { id: 'welcome_8', speaker: 'bean',  text: "[excited] The rules are simple! I ask questions, you tap answers, and at NO point does anyone give me a snack, which I think is a FLAW in the FORMAT." },
        { id: 'welcome_9', speaker: 'tiger', text: "[smug] Bean Quiz is filmed in front of a live studio audience. [whispers] The audience is a dog. She is also the host." },
        { id: 'welcome_10', speaker: 'bean', text: "[gasps] Wait, is it on? Are we ON?! [dramatic] Ahem. Somewhere in this vehicle... sits a champion." },
      ],
      howMany: [
        ...
        { id: 'howmany_4', speaker: 'tiger', text: "[deadpan] Choose carefully. Last week someone picked 'four' and three of them were the same kid in different hats." },
        { id: 'howmany_5', speaker: 'bean',  text: "[excited] One player? Cozy! Five players? CHAOS! There are no wrong answers, only louder ones!" },
      ],
      namesReady: [
        ...
        { id: 'names_5', speaker: 'tiger', text: "[sighs] I went to cat law school for this." },
        { id: 'names_6', speaker: 'bean',  text: "[excited] These names were chosen by a jury of raccoons! All decisions are final!" },
        { id: 'names_7', speaker: 'tiger', text: "[smug] Don't like your name? Tap it. The name machine is legally required to try again." },
      ],
      pickTopic: [
        ...
        { id: 'topic_5', speaker: 'bean',  text: "[excited] Pick a topic! Pick with your heart! Or your finger! Ideally your finger — the screen can't read hearts!" },
        { id: 'topic_6', speaker: 'tiger', text: "[deadpan] Girl Power is on the board. My lawyer, who is a girl, insisted. She was right. She's always right." },
        { id: 'topic_7', speaker: 'bean',  text: "[gasps] Ooh, GIRL POWER! Fun fact: I am a girl AND a power. Next question." },
      ],
      correct: [
        ...
        { id: 'correct_13', speaker: 'bean',  text: "[shouting] CORRECT! [excited] Somewhere, a confetti cannon just got a promotion!" },
        { id: 'correct_14', speaker: 'tiger', text: "[impressed] Correct. I'd slow-clap, but my paws are basically croissants. Look at them. Croissants." },
        { id: 'correct_15', speaker: 'bean',  text: "[excited] YES! That answer was so right it looped around and became a lifestyle!" },
        { id: 'correct_16', speaker: 'tiger', text: "[deadpan] Right answer. The scoreboard just felt joy for the first time." },
        { id: 'correct_17', speaker: 'bean',  text: "[gasps] Correct! [whispers] Are you a wizard? Blink twice if you're a wizard." },
        { id: 'correct_18', speaker: 'tiger', text: "[smug] Correct. Exactly as I predicted, in my head, just now, right after you said it." },
      ],
      wrong: [
        ...
        { id: 'wrong_11', speaker: 'bean',  text: "[aww] Wrong! But in a fun way! Like when I brought Dan a live frog. Wrong gift. GREAT story." },
        { id: 'wrong_12', speaker: 'tiger', text: "[deadpan] Incorrect. The answer you picked has been escorted from the building." },
        { id: 'wrong_13', speaker: 'bean',  text: "[dramatic] Nooo! [happily] Okay, I'm over it. Dogs live in the moment. New moment! Hi! Who are you?" },
        { id: 'wrong_14', speaker: 'tiger', text: "[smug] Wrong. But CONFIDENTLY wrong, which in show business is called 'a career.'" },
        { id: 'wrong_15', speaker: 'bean',  text: "[excited] Not it! Fun fact: being wrong burns eleven calories! You're basically exercising!" },
      ],
      close: [
        ...
        { id: 'close_4', speaker: 'tiger', text: "[impressed] So close, the right answer felt the breeze." },
      ],
      trickWarn: [
        ...
        { id: 'trick_4', speaker: 'tiger', text: "[whispers] This question was written by a criminal mastermind. [smug] Me. I wrote it." },
      ],
      turn: [
        ...
        { id: 'turn_5', speaker: 'bean',  text: "[excited] New contestant, same rules! Gravity still applies, answers still count!" },
        { id: 'turn_6', speaker: 'tiger', text: "[yawns] You're up. I believe in you the normal amount." },
      ],
      roundEnd: [
        ...
        { id: 'roundend_4', speaker: 'tiger', text: "[deadpan] End of round. Time to look at numbers and feel things." },
        { id: 'roundend_5', speaker: 'bean',  text: "[excited] Scoreboard time! Numbers! My favorite letters!" },
      ],
      win: [
        ...
        { id: 'win_5', speaker: 'bean',  text: "[shouting] CHAMPION! [excited] You get glory, confetti, and a crown that lives inside a screen!" },
        { id: 'win_6', speaker: 'tiger', text: "[deadpan] You've won a prize beyond value. Because it has no value. It's pride. Congratulations." },
        { id: 'win_7', speaker: 'bean',  text: "[happily] Winner winner! [whispers] ...chicken dinner. [gasps] WAIT. WHERE?" },
      ],
      tapBean: [
        ...
        { id: 'tapbean_5', speaker: 'bean', text: "[excited] Boop registered! Your boop is important to us! A representative will wag shortly!" },
        { id: 'tapbean_6', speaker: 'bean', text: "[gasps] You found my button! I have exactly one button and it's ALL of me!" },
      ],
      tapTiger: [
        ...
        { id: 'taptiger_5', speaker: 'tiger', text: "[annoyed] Do I come to YOUR house and poke YOU during YOUR quiz show?" },
        { id: 'taptiger_6', speaker: 'tiger', text: "[purrs] Mmm. One more of those and I'll legally have to like you." },
      ],
      golden: [
        ...
        { id: 'golden_3', speaker: 'bean', text: "[whispers] The Golden Bean... [shouting] THE GOLDEN BEAN! [excited] Double points! I've only seen one other in the wild!" },
        { id: 'golden_4', speaker: 'tiger', text: "[deadpan] Golden Bean. Worth double. Appraised by a raccoon we trust." },
      ],
      // ── New in the mega-upgrade ───────────────────────────────────────────
      sponsors: [
        { id: 'sponsor_1', speaker: 'tiger', text: "[deadpan] Bean Quiz is brought to you by... Invisible Tennis Balls. You already own several. Ask your dog." },
        { id: 'sponsor_2', speaker: 'bean',  text: "[excited] This round is sponsored by NAPS! Naps: they're like being asleep... but shorter! [whispers] Naps. Ask your cat." },
        { id: 'sponsor_3', speaker: 'tiger', text: "[smug] Sponsored by the Empty Cardboard Box Council. If it fits, it sits. That's not a slogan. It's the law." },
        { id: 'sponsor_4', speaker: 'bean',  text: "[excited] Brought to you by SQUIRRELS! [whispers] Where ARE they? What do they KNOW? [normal] Squirrels." },
        { id: 'sponsor_5', speaker: 'tiger', text: "[bored] Tonight's scores are measured in points. Points: worth nothing, and yet... everything." },
        { id: 'sponsor_6', speaker: 'bean',  text: "[happily] Bean Quiz is brought to you by the letter B, the number one hundred, and one very good girl. [whispers] It's me. I'm the girl." },
      ],
      streak: [
        { id: 'streak_1', speaker: 'bean',  text: "[shouting] THREE IN A ROW! [excited] Zoomies protocol activated! Clear the furniture!" },
        { id: 'streak_2', speaker: 'tiger', text: "[deadpan] A streak. Great. Now the dog is running in circles. This is your fault." },
        { id: 'streak_3', speaker: 'bean',  text: "[excited] You're ON FIRE! [normal] Not literally! Legal made me say that!" },
        { id: 'streak_4', speaker: 'tiger', text: "[impressed] Still correct? Suspicious. I'm having your water bowl tested." },
      ],
      comeback: [
        { id: 'comeback_1', speaker: 'bean',  text: "[gasps] A COMEBACK! This is better than television! [whispers] Wait. This IS television. Sort of." },
        { id: 'comeback_2', speaker: 'tiger', text: "[smug] The underdog rises. As a cat, I'm contractually against underdogs. But... respect." },
      ],
      finalRound: [
        { id: 'final_1', speaker: 'bean',  text: "[dramatic] THE FINAL ROUND! Every question worth DOUBLE points! [whispers] I can smell the tension. It smells like... pretzels?" },
        { id: 'final_2', speaker: 'tiger', text: "[sinister] The final round. Double points. Anyone could win. [chuckles] Statistically, someone must." },
      ],
      tie: [
        { id: 'tie_1', speaker: 'bean',  text: "[gasps] A TIE?! The scoreboard is SWEATING!" },
        { id: 'tie_2', speaker: 'tiger', text: "[deadpan] A tie. Everyone wins. No one wins. Philosophy." },
      ],
      zeroScore: [
        { id: 'zero_1', speaker: 'bean',  text: "[softly] Zero points is just a fresh start with extra steps! I love you unconditionally!" },
        { id: 'zero_2', speaker: 'tiger', text: "[deadpan] Zero. A perfect circle. Very hard to draw. Take the win." },
      ],
      fifty: [
        { id: 'fifty_1', speaker: 'tiger', text: "[smug] Tiger's Paw of Fate! Two wrong answers — gone. Knocked off the table of destiny." },
        { id: 'fifty_2', speaker: 'tiger', text: "[deadpan] I removed two bad answers. I do this to mugs, too. It's a gift." },
        { id: 'fifty_3', speaker: 'tiger', text: "[chuckles] The paw has spoken. Choose from what survives." },
      ],
      speed: [
        { id: 'speed_1', speaker: 'bean',  text: "[excited] LIGHTNING FAST! Speed bonus! Were you raised by greyhounds?!" },
        { id: 'speed_2', speaker: 'tiger', text: "[impressed] Quick. Very quick. Almost cat-level. Almost." },
      ],
      pinkHorse: [
        { id: 'horse_1', speaker: 'bean',  text: "[gasps] Did anyone else see a PINK HORSE?! [whispers] The prophecy is real." },
        { id: 'horse_2', speaker: 'tiger', text: "[deadpan] That was the Pink Horse of Whimsy. She owns this arcade. We don't ask questions." },
      ],
      disco: [
        { id: 'disco_1', speaker: 'bean',  text: "[shouting] DISCO MODE! [singing] The Bean is in the buil-ding!" },
        { id: 'disco_2', speaker: 'tiger', text: "[sighs] She does this. There's no stopping it. Enjoy the light show." },
      ],
      sting: [
    ...
    topics: [
      ...
      { id: 'world', name: 'Robots & Tech', emoji: '🤖', color: '#ef4444', questions: [
