...
1. **Play-Test Spotlight (10 min):** A student demos on the projector.
2. **Featured Game (5 min):** A game Brian Lowe worked on, matching the week's topic.
...
| 6 | May 22 | 3D | Interaction, enemies, storytelling | Ace Patrol | |
| 7 | May 29 | 3D | Polish, levels, publishing prep | Rampage 2 | |
| 8 | Jun 5 | Demo Day | Parents, arcade, celebrate! | All of them | Brian |

## Downloads

All course materials are available as printable PDFs from the [Worksheets](/docs/worksheets/) section.
