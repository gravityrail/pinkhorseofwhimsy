...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function kl(){return new ri({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Tc(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function Hl(){return new ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Tc(),fragmentShader:`
	...
	`}function $g(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===ua||c===ha,h=c===ss||c===rs;if(l||h){let u=e.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new Bl(s)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new Bl(s)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Zg(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Zs("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Jg(s,e,t,n){const i={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const f in d)e.update(d[f],s.ARRAY_BUFFER)}function l(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const b=f.array;_=f.version;for(let E=0,M=b.length;E<M;E+=3){const R=b[E+0],w=b[E+1],P=b[E+2];d.push(R,w,w,P,P,R)}}else if(g!==void 0){const b=g.array;_=g.version;for(let E=0,M=b.length/3-1;E<M;E+=3){const R=E+0,w=E+1,P=E+2;d.push(R,w,w,P,P,R)}}else return;const m=new(Du(d)?Ou:Fu)(d,1);m.version=_;const p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function Qg(s,e,t){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){s.drawElements(n,f,r,d*o),t.update(f,n,1)}function l(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function u(d,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)l(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let b=0;b<g;b++)p+=f[b]*_[b];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function e_(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function t_(s,e,t){const n=new WeakMap,i=new $e;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let S=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",S)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let E=0;f===!0&&(E=1),g===!0&&(E=2),_===!0&&(E=3);let M=a.attributes.position.count*E,R=1;M>e.maxTextureSize&&(R=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const w=new Float32Array(M*R*4*u),P=new Uu(w,M,R,u);P.type=gn,P.needsUpdate=!0;const U=E*4;for(let y=0;y<u;y++){const L=m[y],O=p[y],H=b[y],W=M*R*4*y;for(let Y=0;Y<L.count;Y++){const X=Y*U;f===!0&&(i.fromBufferAttribute(L,Y),w[W+X+0]=i.x,w[W+X+1]=i.y,w[W+X+2]=i.z,w[W+X+3]=0),g===!0&&(i.fromBufferAttribute(O,Y),w[W+X+4]=i.x,w[W+X+5]=i.y,w[W+X+6]=i.z,w[W+X+7]=0),_===!0&&(i.fromBufferAttribute(H,Y),w[W+X+8]=i.x,w[W+X+9]=i.y,w[W+X+10]=i.z,w[W+X+11]=H.itemSize===4?i.w:1)}}d={count:u,texture:P,size:new De(M,R)},n.set(a,d),a.addEventListener("dispose",S)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<l.length;_++)f+=l[_];const g=a.morphTargetsRelative?1:1-f;c.getUniforms().setValue(s,"morphTargetBaseInfluence",g),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function n_(s,e,t,n){let i=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l))}return u}function o(){i=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}const nh=new Et,Vl=new Ku(1,1),ih=new Uu,sh=new Yd,rh=new ku,Gl=[],Wl=[],Xl=new Float32Array(16),ql=new Float32Array(9),Yl=new Float32Array(4);function xs(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Gl[i];if(r===void 0&&(r=new Float32Array(i),Gl[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function bt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function At(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function co(s,e){let t=Wl[e];t===void 0&&(t=new Int32Array(e),Wl[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function i_(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function s_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;s.uniform2fv(this.addr,e),At(t,e)}}function r_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(bt(t,e))return;s.uniform3fv(this.addr,e),At(t,e)}}function o_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;s.uniform4fv(this.addr,e),At(t,e)}}function a_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(bt(t,n))return;Yl.set(n),s.uniformMatrix2fv(this.addr,!1,Yl),At(t,n)}}function c_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(bt(t,n))return;ql.set(n),s.uniformMatrix3fv(this.addr,!1,ql),At(t,n)}}function l_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(bt(t,n))return;Xl.set(n),s.uniformMatrix4fv(this.addr,!1,Xl),At(t,n)}}function u_(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function h_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;s.uniform2iv(this.addr,e),At(t,e)}}function d_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(bt(t,e))return;s.uniform3iv(this.addr,e),At(t,e)}}function f_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;s.uniform4iv(this.addr,e),At(t,e)}}function p_(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function m_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;s.uniform2uiv(this.addr,e),At(t,e)}}function g_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(bt(t,e))return;s.uniform3uiv(this.addr,e),At(t,e)}}function __(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;s.uniform4uiv(this.addr,e),At(t,e)}}function x_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Vl.compareFunction=Iu,r=Vl):r=nh,t.setTexture2D(e||r,i)}function v_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||sh,i)}function M_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||rh,i)}function y_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||ih,i)}function S_(s){switch(s){case 5126:return i_;case 35664:return s_;case 35665:return r_;case 35666:return o_;case 35674:return a_;case 35675:return c_;case 35676:return l_;case 5124:case 35670:return u_;case 35667:case 35671:return h_;case 35668:case 35672:return d_;case 35669:case 35673:return f_;case 5125:return p_;case 36294:return m_;case 36295:return g_;case 36296:return __;case 35678:case 36198:case 36298:case 36306:case 35682:return x_;case 35679:case 36299:case 36307:return v_;case 35680:case 36300:case 36308:case 36293:return M_;case 36289:case 36303:case 36311:case 36292:return y_}}function T_(s,e){s.uniform1fv(this.addr,e)}function E_(s,e){const t=xs(e,this.size,2);s.uniform2fv(this.addr,t)}function b_(s,e){const t=xs(e,this.size,3);s.uniform3fv(this.addr,t)}function A_(s,e){const t=xs(e,this.size,4);s.uniform4fv(this.addr,t)}function w_(s,e){const t=xs(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function R_(s,e){const t=xs(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function C_(s,e){const t=xs(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function P_(s,e){s.uniform1iv(this.addr,e)}function L_(s,e){s.uniform2iv(this.addr,e)}function I_(s,e){s.uniform3iv(this.addr,e)}function D_(s,e){s.uniform4iv(this.addr,e)}function U_(s,e){s.uniform1uiv(this.addr,e)}function N_(s,e){s.uniform2uiv(this.addr,e)}function F_(s,e){s.uniform3uiv(this.addr,e)}function O_(s,e){s.uniform4uiv(this.addr,e)}function B_(s,e,t){const n=this.cache,i=e.length,r=co(t,i);bt(n,r)||(s.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||nh,r[o])}function z_(s,e,t){const n=this.cache,i=e.length,r=co(t,i);bt(n,r)||(s.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||sh,r[o])}function k_(s,e,t){const n=this.cache,i=e.length,r=co(t,i);bt(n,r)||(s.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||rh,r[o])}function H_(s,e,t){const n=this.cache,i=e.length,r=co(t,i);bt(n,r)||(s.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||ih,r[o])}function V_(s){switch(s){case 5126:return T_;case 35664:return E_;case 35665:return b_;case 35666:return A_;case 35674:return w_;case 35675:return R_;case 35676:return C_;case 5124:case 35670:return P_;case 35667:case 35671:return L_;case 35668:case 35672:return I_;case 35669:case 35673:return D_;case 5125:return U_;case 36294:return N_;case 36295:return F_;case 36296:return O_;case 35678:case 36198:case 36298:case 36306:case 35682:return B_;case 35679:case 36299:case 36307:return z_;case 35680:case 36300:case 36308:case 36293:return k_;case 36289:case 36303:case 36311:case 36292:return H_}}class G_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=S_(t.type)}}class W_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=V_(t.type)}}class X_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const Ko=/(\w+)(\])?(\[|\.)?/g;function Kl(s,e){s.seq.push(e),s.map[e.id]=e}function q_(s,e,t){const n=s.name,i=n.length;for(Ko.lastIndex=0;;){const r=Ko.exec(n),o=Ko.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){Kl(t,l===void 0?new G_(a,s,e):new W_(a,s,e));break}else{let u=t.map[a];u===void 0&&(u=new X_(a),Kl(t,u)),t=u}}}class Yr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);q_(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function jl(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Y_=37297;let K_=0;function j_(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const $l=new ze;function $_(s){Ke._getMatrix($l,Ke.workingColorSpace,s);const e=`mat3( ${$l.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(s)){case Jr:return[e,"LinearTransferOETF"];case nt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Zl(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`
...
`)}function J_(s,e){let t;switch(e){case sd:t="Linear";break;case rd:t="Reinhard";break;case od:t="Cineon";break;case Mu:t="ACESFilmic";break;case cd:t="AgX";break;case ld:t="Neutral";break;case ad:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Or=new C;function Q_(){Ke.getLuminanceCoefficients(Or);const s=Or.x.toFixed(4),e=Or.y.toFixed(4),t=Or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function e0(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fs).join(`
`)}function t0(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function n0(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function Fs(s){return s!==""}function Jl(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ql(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const i0=/^[ \t]*#include +<([\w\d./]+)>/gm;function qa(s){return s.replace(i0,r0)}const s0=new Map;function r0(s,e){let t=He[e];if(t===void 0){const n=s0.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return qa(t)}const o0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function eu(s){return s.replace(o0,a0)}function a0(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function tu(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function c0(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===_u?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===xu?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function l0(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case ss:case rs:e="ENVMAP_TYPE_CUBE";break;case so:e="ENVMAP_TYPE_CUBE_UV";break}return e}function u0(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===rs&&(e="ENVMAP_MODE_REFRACTION"),e}function h0(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case vu:e="ENVMAP_BLENDING_MULTIPLY";break;case nd:e="ENVMAP_BLENDING_MIX";break;case id:e="ENVMAP_BLENDING_ADD";break}return e}function d0(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function f0(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=c0(t),l=l0(t),h=u0(t),u=h0(t),d=d0(t),f=e0(t),g=t0(r),_=i.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const E=b+m+o,M=b+p+a,R=jl(i,i.VERTEX_SHADER,E),w=jl(i,i.FRAGMENT_SHADER,M);i.attachShader(_,R),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function P(L){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_)||"",H=i.getShaderInfoLog(R)||"",W=i.getShaderInfoLog(w)||"",Y=O.trim(),X=H.trim(),ne=W.trim();let V=!0,oe=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,R,w);else{const he=Zl(i,R,"vertex"),Ee=Zl(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
uniform vec2 catWorld;`),d.vertexShader=d.vertexShader.replace("#include <begin_vertex>",`#include <begin_vertex>
          ...
          `),ph.push(d.uniforms)},c.material.needsUpdate=!0}/Lawn|Grass patch|Grass blades|Leaf green|Sunlit leaf|Deep leaf|Autumn .* leaf|Terracotta brick|Warm brick|Drive concrete|Street asphalt|Utility poles and wires|Warm indoor floor|Patio canopy roof/i.test(l)||dh.push(c)}),vt.add(i),Ix();const r=n.scene;r.position.copy(Hs);const o=[],a=[];r.traverse(c=>{c.isMesh&&(c.castShadow=!0,c.receiveShadow=!0),c.name.startsWith("ac_leg_")&&o.push({part:c,restY:c.position.y}),c.name.startsWith("ac_eye_lamp")&&a.push(c)}),yt={model:r,cover:r.getObjectByName("ac_mouth_cover"),upperTeeth:r.getObjectByName("ac_upper_teeth"),lowerTeeth:r.getObjectByName("ac_lower_teeth"),legs:o,eyes:a,coverRest:0,state:"sleeping",wakeTime:0,stunTimer:0,stomps:0,direction:1,marchTime:0,smoke:[]},yt.coverRest=yt.cover.position.y,Dx(),vt.add(r),Eh(),Rx("LET'S GO","#332715","#f4dc97"),k=e.scene,k.rotation.order="YXZ",k.traverse(c=>{c.isMesh&&(c.castShadow=!0,c.receiveShadow=!0)});for(const c of["leg_front_left","leg_front_right","leg_hind_left","leg_hind_right"])Kr[c]=k.getObjectByName(c),Kr[c]&&(hh[c]=Kr[c].rotation.clone());Ki=k.getObjectByName("tail_pivot"),ja=k.getObjectByName("head_pivot"),Si=k.getObjectByName("flexible_tail"),Si?.isMesh&&(ji=new Float32Array(Si.geometry.attributes.position.array),Si.geometry.attributes.position.setUsage(Td)),k.position.set(0,0,25),k.visible=!1,vt.add(k),du=t.scene,Ax.forEach(([c,l],h)=>{const u=du.clone(!0);u.position.set(c,0,l),u.rotation.y=Gs(h+8)*Math.PI*2,u.traverse(g=>{g.isMesh&&(g.castShadow=!0,g.receiveShadow=!0)}),vt.add(u);const d=[];u.traverse(g=>{g.name.startsWith("brain pip")&&d.push(g)});const f=[];u.traverse(g=>{g.name.startsWith("ant_leg_")&&f.push(g)}),Gn.push({model:u,brains:d,legs:f,x:c,z:l,homeX:c,homeZ:l,health:3,awake:!0,phase:Gs(h+4)*10,targetX:c,targetZ:l,decision:0,attackCooldown:0,hitCooldown:0,fall:0})}),we.loading.classList.add("hidden"),qe="title",rr(),we.debugJump.disabled=!1,we.debugDefeat.disabled=!1}catch(s){console.error(s),we.loading.textContent="Could not load the backyard models. Refresh to try again."}function bh(){qe==="title"&&(Lt.start(),qe="intro",Os=0,k.visible=!0,we.start.classList.add("hidden"),we.hud.classList.remove("hidden"),we.controls.classList.remove("hidden"),bc(),k.position.set(0,0,25),k.rotation.set(0,0,0),ft.position.set(0,1.48,28.9),ft.lookAt(0,1.05,21),bi.set(0,1.05,21),ns=0,bn=0,Wt("Follow Tiger through the cat flap…"))}function Ah(){Mt===2?(we.missionLabel.textContent="FRONT YARD",we.mission.innerHTML='Condenser stomps <strong id="ac-count"></strong>',we.acCount=document.getElementById("ac-count"),we.acCount.textContent=`${yt?.stomps||0} / 5`):(we.missionLabel.textContent="BACKYARD PATROL",we.mission.innerHTML='Soldier ants asleep <strong id="ant-count"></strong>',we.antCount=document.getElementById("ant-count"),rr()),we.debugLevel.value=String(Mt)}function Ox(s){!Ec||!k||(Lt.start(),at.clear(),Eh(),Mt=s,qe="playing",yi=null,ue=null,st=0,Yt=0,hn=0,k.visible=!0,k.scale.set(1,1,1),k.rotation.set(0,0,0),Kt=s===1?0:Math.PI,k.position.set(s===1?0:20.2,0,s===1?9.5:30.2),k.rotation.y=-Kt,ns=Kt,bn=0,ft.position.set(k.position.x,8,k.position.z+(s===1?7:-8)),bi.copy(k.position).add(new C(0,1.05,0)),ft.lookAt(bi),vt.fog.near=s===1?31:50,vt.fog.far=s===1?78:145,_n.visible=!0,we.charge.classList.add("hidden"),we.start.classList.add("hidden"),we.end.classList.add("hidden"),we.hud.classList.remove("hidden"),we.controls.classList.remove("hidden"),bc(),Ah(),Wt(s===1?"Back to the backyard!":"Exploring the front yard!"))}function Bx(){if(!(!Ec||!Gn.length)){for(const s of Gn){s.health=0,s.awake=!1,s.hitCooldown=0,s.fall=1,s.model.rotation.z=1.35,s.model.position.y=.04;for(const e of s.brains)e.visible=!1}io=Gn.length,rr(),Th(),Wt("All ants asleep. The jump pad is ready!")}}we.debugJump.addEventListener("click",()=>Ox(Number(we.debugLevel.value)));we.debugDefeat.addEventListener("click",Bx);function Qa(){location.reload()}document.getElementById("start-button").addEventListener("click",bh);document.getElementById("restart-button").addEventListener("click",Qa);window.addEventListener("keydown",s=>{["Space","ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(s.code)&&s.preventDefault(),at.add(s.code),s.code==="Enter"&&(qe==="title"?bh():(qe==="won"||qe==="lost")&&Qa()),s.code==="KeyR"&&(qe==="won"||qe==="lost")&&Qa(),s.code==="KeyJ"&&vs(),!s.repeat&&(s.code==="KeyK"||s.code==="KeyP")&&wh(s.code),!s.repeat&&s.code==="Space"&&Rh(s.code)});window.addEventListener("keyup",s=>{at.delete(s.code),ec(s.code)});window.addEventListener("blur",()=>{at.clear(),ue?.phase==="crouch"&&(ue=null)});si.addEventListener("pointerdown",s=>{s.button===0&&qe==="playing"&&s.pointerType!=="touch"&&(at.add("MouseSwipe"),vs()),(s.button===2||s.pointerType==="touch"&&s.target===si)&&(lo=!0,Ja=s.clientX,si.setPointerCapture(s.pointerId))});si.addEventListener("pointerup",s=>{at.delete("MouseSwipe"),lo=!1,si.hasPointerCapture(s.pointerId)&&si.releasePointerCapture(s.pointerId)});si.addEventListener("pointermove",s=>{lo&&(bn-=(s.clientX-Ja)*.006,bn=Pt(bn,-1.15,1.15),Ja=s.clientX)});for(const s of document.querySelectorAll("#touch-controls button")){const e=s.dataset.key||{run:"ShiftLeft",jump:"Space",swipe:"KeyJ",pounce:"KeyK"}[s.dataset.action];s.addEventListener("pointerdown",t=>{t.preventDefault(),at.add(e),s.setPointerCapture(t.pointerId),e==="Space"&&Rh(e),e==="KeyJ"&&vs(),e==="KeyK"&&wh(e)}),s.addEventListener("pointerup",t=>{t.preventDefault(),at.delete(e),ec(e)}),s.addEventListener("pointercancel",()=>{at.delete(e),ec(e)})}function Pc(s,e,t=.75){const n=new nn({color:e,transparent:!0,opacity:.9,side:Dt,depthWrite:!1}),i=new xt(new oo(.35,.45,24),n);i.rotation.x=-Math.PI/2,i.position.copy(s),i.position.y=.08,i.scale.setScalar(t),vt.add(i),$r.push({mesh:i,age:0,life:.35})}const $r=[];function zx(s){!s.awake||s.hitCooldown>0||(s.health--,Lt.hit(),s.hitCooldown=.48,s.brains[s.health]&&(s.brains[s.health].visible=!1),Pc(s.model.position,16768108,1.1),s.model.position.y=.17,s.health<=0?(s.awake=!1,io++,Wt("Soldier ant knocked out!"),rr(),io===Gn.length&&(Th(),Wt("The jump pad by the truck is glowing!"))):Wt(`${s.health} brain${s.health===1?"":"s"} left`))}function vs(){if(qe!=="playing")return;if(ue&&(ue.phase==="crouch"||ue.phase==="air")){ue.swipeOnLand=!0;return}if(Qs>0)return;Qs=.48,hn=.42,Lt.swipe(),Za*=-1;const s=new C(Math.sin(Kt),0,-Math.cos(Kt)),e=k.position.clone().addScaledVector(s,1.25);Pc(e,16769703,1.3);let t=null,n=2.8;for(const i of Gn){if(!i.awake)continue;const r=Ex.subVectors(i.model.position,k.position);r.y=0;const o=r.length();o<n&&(t=i,n=o)}t?zx(t):Px(e)&&Lt.hit()}function wh(s="KeyK"){if(qe==="playing"){if(ue){ue.phase==="land"?vs():ue.swipeOnLand=!0;return}st>.05||(ue={phase:"crouch",time:0,trigger:s,releaseRequested:!1,swipeOnLand:!0})}}function Rh(s="Space"){ue||st>.05||qe!=="playing"||(ue={phase:"crouch",time:0,trigger:s,releaseRequested:!1,swipeOnLand:!1})}function ec(s){ue?.phase==="crouch"&&ue.trigger===s&&(ue.releaseRequested=!0)}function Lc(s){if(ds>0||qe!=="playing")return;ds=3.5,Zi=Math.max(0,Zi-1);const e=k.position.clone().sub(s.model.position).setY(0);e.lengthSq()<.001&&e.set(0,0,1),k.position.addScaledVector(e.normalize(),1.4),Ch(k.position.clone()),rr(),Wt(Zi>0?"Ouch! One life lost.":"Tiger is out of lives!"),Zi===0&&setTimeout(()=>kx(),650)}function kx(s){qe==="playing"&&(qe="lost",document.getElementById("end-eyebrow").textContent="NINE LIVES, ONE BRAVE CAT",document.getElementById("end-title").innerHTML="TRY AGAIN,<br><span>TIGER!</span>",document.getElementById("end-copy").textContent="The ants got the better of Tiger this time.",we.end.classList.remove("hidden"),we.controls.classList.add("hidden"),we.touch.classList.add("hidden"))}function Hx(){qe!=="playing"||Mt!==1||!It?.active||(qe="transition",yi={time:0,from:k.position.clone()},at.clear(),Kt=Math.PI,ue={phase:"air",time:0,swipeOnLand:!1},hn=0,Yt=8,Lt.effort(),Wt("Over the fence, Tiger!"))}function Vx(s){yi.time+=s;const e=Pt(yi.time/1.45,0,1),t=ln(0,1,e);k.position.x=Va.lerp(yi.from.x,20.2,t),k.position.z=Va.lerp(yi.from.z,26.6,t),st=3.55*Math.sin(Math.PI*e),Yt=3.55*Math.PI/1.45*Math.cos(Math.PI*e),ue.time+=s,k.position.y=st,k.rotation.y=-Math.PI,k.rotation.x=Yt>0?.15:-.1,k.rotation.z=0,Ic(s,0),_n.position.set(k.position.x,.018,k.position.z),_n.material.opacity=Math.max(0,1-st*.23);const n=new C(k.position.x+6.7,7.6,k.position.z-4.7);ft.position.lerp(n,1-Math.exp(-s*3.8)),bi.lerp(k.position.clone().add(new C(0,1.3,0)),1-Math.exp(-s*5)),ft.lookAt(bi),e>=1&&(qe="playing",Mt=2,yi=null,ue={phase:"land",time:0,swipeOnLand:!1},st=0,Yt=0,k.position.y=0,_n.material.opacity=1,ns=Kt,bn=0,vt.fog.near=50,vt.fog.far=145,Ah(),Lt.hit(),Wt("The front yard is yours to explore!"))}function Ch(s){let e=null;const t=k.position.x,n=k.position.z;if(k.position.x=Pt(k.position.x,-18.4,31.5),k.position.z=Mt===1?Pt(k.position.z,-18.4,18.55):Pt(k.position.z,22.8,95.5),(k.position.x!==t||k.position.z!==n)&&(e="fence or house"),Mt===1){const r=k.position.x,o=k.position.z+2.5;if(Math.hypot(r,o)<1.05){const a=Math.atan2(o,r);k.position.x=Math.cos(a)*1.05,k.position.z=-2.5+Math.sin(a)*1.05,e="oak trunk"}}const i=Mt===1?gh:[...xh,Mh()].filter(Boolean);for(const[r,o,a,c,l,h]of i)if(st<=h&&k.position.x>o&&k.position.x<a&&k.position.z>c&&k.position.z<l){const u=[[Math.abs(k.position.x-o),"x",o],[Math.abs(k.position.x-a),"x",a],[Math.abs(k.position.z-c),"z",c],[Math.abs(k.position.z-l),"z",l]];u.sort((d,f)=>d[0]-f[0]),k.position[u[0][1]]=u[0][2],e=r}for(const[r,o,a,c,l]of Mt===1?_h:vh){if(st>l)continue;const h=k.position.x-o,u=k.position.z-a,d=Math.hypot(h,u);if(d<c){const f=d>.001?Math.atan2(u,h):Math.atan2(s.z-a,s.x-o);k.position.x=o+Math.cos(f)*c,k.position.z=a+Math.sin(f)*c,e=r}}return!Number.isFinite(k.position.x)||!Number.isFinite(k.position.z)?(k.position.copy(s),null):e}function Gx(s){if(ue)if(ue.time+=s,ue.phase==="crouch"&&ue.releaseRequested&&ue.time>=.18){const e=Pt((ue.time-.18)/2.82,0,1);ue.phase="air",ue.time=0,Lt.effort(),Yt=6.3+3.7*e,ue.swipeOnLand&&Wt("POUNCE!")}else if(ue.phase==="air"){const e=st;Yt-=16*s,st+=Yt*s,Mt===2&&yt&&(yt.state==="marching"||yt.state==="stunned")&&!ue.stompedAc&&Yt<0&&e>Vs&&st<=Vs&&Rc(k.position.x,k.position.z,.15)&&(ue.stompedAc=!0,Ux(),st=Vs+.04,Yt=4.1),st<=0&&(st=0,Yt=0,ue.phase="land",ue.time=0,Sh(k.position)!=="grass"&&Ji<=0&&(Lt.hit(),Ji=.25),ue.swipeOnLand&&(Qs=0,vs()))}else ue.phase==="land"&&ue.time>=.22&&(ue=null)}function Ic(s,e){const t=Pt(e/4.4,0,1);Us+=s*(1+t*.36),t>.05&&(er+=s*(6+e*1.48));const n=Math.sin(er),i={leg_front_left:n,leg_hind_right:n,leg_front_right:-n,leg_hind_left:-n},r=hn>0?1-hn/.42:0,o=Za>0?"leg_front_right":"leg_front_left";for(const[a,c]of Object.entries(Kr)){if(!c)continue;const l=hh[a],h=a.includes("hind");let u=(i[a]||0)*.52*t,d=1,f=0;if(ue?.phase==="crouch"&&(u=h?.5:.1,d=h?.74:.94),ue?.phase==="air"){const _=Yt>0;u=h?_?-1.02:-.52:_?.78:.23,d=h?_?1.22:1.08:_?.89:1.04}ue?.phase==="land"&&(u=(h?-.14:.67)*(1-ln(0,.22,ue.time)),d=h?1:1.06-.06*ln(0,.22,ue.time)),hn>0&&a===o&&(u+=Math.sin(r*Math.PI)*1.05,f=(Za>0?1:-1)*Math.cos(r*Math.PI)*.72);const g=1-Math.exp(-s*24);c.rotation.x+=(l.x+u-c.rotation.x)*g,c.rotation.z+=(l.z+f-c.rotation.z)*g,c.scale.y+=(d-c.scale.y)*g}if(Ki){const a=ue?.phase==="air"?-.22:0;Ki.rotation.y+=(Math.sin(Us*2.1)*.12-Ki.rotation.y)*(1-Math.exp(-s*7)),Ki.rotation.x+=(a-Ki.rotation.x)*(1-Math.exp(-s*8))}if(Si&&ji){const a=Si.geometry.attributes.position,c=hn>0||ue?.23:.1+t*.12;for(let l=0;l<a.count;l++){const h=l*3,u=Pt(ji[h+2]/1.37,0,1),d=u*u;a.setXYZ(l,ji[h]+d*(Math.sin(Us*2.9-u*2.8)*c+Math.sin(Us*7.4-u*4.3)*.055),ji[h+1]+d*Math.sin(Us*2.3-u*2)*.075,ji[h+2])}a.needsUpdate=!0,Si.geometry.computeVertexNormals()}}function Wx(s){Ji=Math.max(0,Ji-s);const e=Number(at.has("KeyW")||at.has("ArrowUp"))-Number(at.has("KeyS")||at.has("ArrowDown")),t=Number(at.has("KeyD")||at.has("ArrowRight"))-Number(at.has("KeyA")||at.has("ArrowLeft"));e?Kt+=t*s*2.25:t&&(bn=Pt(bn+t*s*.28,-.28,.28)),Jo+=((e?0:t*.65)-Jo)*(1-Math.exp(-s*9)),ja&&(ja.rotation.y=-Jo);const n=new C(Math.sin(Kt),0,-Math.cos(Kt)).multiplyScalar(e);Gx(s);const i=at.has("ShiftLeft")||at.has("ShiftRight")?7.2:5.2,r=k.position.clone();k.position.addScaledVector(n,i*s*(ue?.phase==="crouch"?0:1));const o=Math.hypot(k.position.x-r.x,k.position.z-r.z)/Math.max(s,.001),a=Ch(r);a&&a!==mu&&o>1.2&&Ji<=0&&(Lt.hit(),Ji=.25),mu=a,a==="air conditioner"&&yt?.state==="marching"&&st<.25&&ue?.phase!=="air"&&Lc(yt),Mt===1&&It?.active&&st<.12&&wc(k.position,mh)<.98&&Hx(),k.rotation.y=-Kt,Ic(s,e&&ue?.phase!=="crouch"?i:0);const c=ue?.phase==="crouch"?.22:ue?.phase==="air"?Yt>0?.16:-.11:ue?.phase==="land"?-.08*(1-ln(0,.22,ue.time)):0;k.rotation.x+=(c-k.rotation.x)*(1-Math.exp(-s*13));let l=1;ue?.phase==="crouch"&&(l=1-.22*ln(0,.18,ue.time)),ue?.phase==="air"&&(l=Yt>0?1.04:.98),ue?.phase==="land"&&(l=.83+.17*ln(0,.22,ue.time)),k.scale.set(1,l,1),k.position.y=st+(e&&!ue?Math.sin(er*2)*.025:0),hn>0?(hn=Math.max(0,hn-s),k.rotation.z=ue?0:Math.sin((1-hn/.42)*Math.PI)*.08):k.rotation.z=0,k.visible=ds<=0||Math.floor(ds*10)%2===0,_n.visible=!0,_n.position.x=k.position.x,_n.position.z=k.position.z,_n.material.opacity=1-st*.23}function gu(s,e){const t=Cc()&&hn<=0&&!ue?.swipeOnLand;Gn.forEach((n,i)=>{if(n.hitCooldown=Math.max(0,n.hitCooldown-s),n.attackCooldown=Math.max(0,n.attackCooldown-s),!n.awake){n.fall=Math.min(1,n.fall+s*3),n.model.rotation.z=n.fall*1.35,n.model.position.y=.04;return}const r=wc(n.model.position,k.position),o=!t&&r<5.2&&qe==="playing";n.decision-=s,!o&&n.decision<=0&&(n.targetX=Pt(n.homeX+(Gs(e*.013+i*8)-.5)*5,-17,17),n.targetZ=Pt(n.homeZ+(Gs(e*.019+i*11)-.5)*5,-17,17),n.decision=1.8+Gs(i+e*.1)*2.8);const a=o?k.position.x:n.targetX,c=o?k.position.z:n.targetZ,l=a-n.model.position.x,h=c-n.model.position.z,u=Math.hypot(l,h),d=u>(o?.85:.25);if(d){const f=o?1.05:.62;n.model.position.x+=l/u*f*s,n.model.position.z+=h/u*f*s,n.model.rotation.y=yh(n.model.rotation.y,-wx(l,h),s*7)}n.model.position.y=n.hitCooldown>0?Math.abs(Math.sin(e*34))*.04:0;for(const f of n.legs){const g=Number(f.name.slice(-1)),_=f.name.includes("_left_"),m=(g+(_?0:1))%2?Math.PI:0,p=e*(o?12:8)+n.phase+m,b=d?Math.sin(p)*.37:0;f.rotation.x+=(b-f.rotation.x)*(1-Math.exp(-s*15)),f.rotation.y=d?Math.max(0,Math.cos(p))*(_?-.17:.17):0}o&&r<.78&&n.attackCooldown<=0&&st<.5&&ue?.phase!=="air"&&(Lc(n),n.attackCooldown=4.5)})}function Qo(s,e,t=dh){const n=e.clone().sub(s),i=n.length();Br.set(s,n.normalize()),Br.near=.35,Br.far=i;const r=Br.intersectObjects(t,!1)[0];return r?Math.max(.35,r.distance-.35):i}function Xx(s){lo||(bn*=Math.exp(-s*.42)),ns=yh(ns,Kt+bn,1-Math.exp(-s*3.2));const e=k.position.clone().add(new C(0,1.05,0)),t=Cc(),n=[{turn:0,height:6.25,distance:8.2,penalty:t?.14:0},{turn:0,height:8.4,distance:7.6,penalty:t?0:.08},{turn:.48,height:6.8,distance:7.8,penalty:.13},{turn:-.48,height:6.8,distance:7.8,penalty:.13}];Mt===2&&k.position.z>58&&k.position.z<70&&Math.abs(k.position.x)<7&&n.unshift({turn:-1.3,height:7.5,distance:15.5,penalty:-.25});let i=null;for(const u of n){const d=ns+u.turn,f=new C(k.position.x-Math.sin(d)*u.distance,u.height,k.position.z+Math.cos(d)*u.distance);f.x=Pt(f.x,-18.5,31.7),f.z=Mt===1?Pt(f.z,-18.5,k.position.x>18.5&&k.position.z>10?27:17.2):Pt(f.z,14.5,97);const g=f.distanceTo(e),_=Qo(e,f),m=Qo(e,f,fh),p=_/g-u.penalty-(m<g?.14*(1-m/g):0);(!i||p>i.score)&&(i={score:p,candidate:f,clear:_,length:g})}const r=i.candidate;i.clear<i.length&&r.lerp(e,1-Math.min(1,Math.max(1.5,i.clear)/i.length));const o=ft.position.distanceTo(e)>r.distanceTo(e);ft.position.lerp(r,1-Math.exp(-s*(o?10:4)));const a=Qo(e,ft.position),c=ft.position.distanceTo(e);a<c&&ft.position.lerp(e,1-Math.min(1,Math.max(1.5,a)/c));const l=new C(Math.sin(Kt),0,-Math.cos(Kt)),h=e.addScaledVector(l,.72);bi.lerp(h,1-Math.exp(-s*7)),ft.lookAt(bi)}function qx(){const s=Math.min(fu.getDelta(),.05),e=fu.elapsedTime;if(qe==="intro"){Os+=s;const n=Pt(Os/3.55,0,1),i=ln(3.25,5.35,Os);k.position.z=25-n*8.4-i*7.1;const r=ln(23.2,20,k.position.z)*(1-ln(19.3,17.6,k.position.z));k.scale.set(1,1-.1*r,1),Ic(s,3.5),k.position.y=Math.sin(er*2)*.018,_n.visible=!0,_n.position.set(k.position.x,.018,k.position.z),ei.rotation.x=ln(23.8,21.7,k.position.z)*1.28;const o=3.9-1.5*ln(21,18,k.position.z),a=new C(0,1.48,k.position.z+o),c=new C(1.5,6.3,17.2);ft.position.copy(a.lerp(c,i)),ft.lookAt(new C(0,1.04,k.position.z-4.4).lerp(new C(0,1.2,k.position.z-3.1),i)),Os>=5.35&&(qe="playing",k.position.z=9.5,k.scale.set(1,1,1),Wt("The backyard is yours to explore!"))}else if(qe==="playing"){Qs=Math.max(0,Qs-s),ds=Math.max(0,ds-s);const n=at.has("KeyJ")||at.has("MouseSwipe");n&&!pu&&vs(),pu=n,Wx(s),gu(s,e),Nx(s),Xx(s),ei&&(ei.rotation.x*=Math.exp(-s*1.5)),Lx()}else qe==="transition"?Vx(s):qe==="title"&&k&&(ft.position.set(13,13,14),ft.lookAt(0,1,-2),gu(s,e));Fx();for(let n=$r.length-1;n>=0;n--){const i=$r[n];i.age+=s,i.mesh.scale.multiplyScalar(1+s*4),i.mesh.material.opacity=Math.max(0,1-i.age/i.life),i.age>=i.life&&(vt.remove(i.mesh),i.mesh.geometry.dispose(),i.mesh.material.dispose(),$r.splice(n,1))}if(jr>0&&(jr-=s,jr<=0&&we.toast.classList.add("hidden")),Mi+=s,It?.active){const n=Mi*1.5%1;It.ring.scale.setScalar(1+n*.48),It.ring.material.opacity=(1-n)*.7,It.light.intensity=1.4+.55*Math.sin(Mi*5),It.base.material.emissiveIntensity=.75+.22*Math.sin(Mi*5)}k&&(Gt.position.set(k.position.x-10,24,k.position.z+10),Gt.target.position.set(k.position.x,0,k.position.z),Gt.target.updateMatrixWorld());for(const n of ph)n.windTime.value=Mi,k&&n.catWorld.value.set(k.position.x,k.position.z);let t=!1;if(k&&(qe==="intro"||qe==="playing")){const n=k.position.clone().add(new C(0,1.05,0)).sub(ft.position),i=n.length();zr.set(ft.position,n.normalize()),zr.near=.05,zr.far=i-.2,t=zr.intersectObjects($a,!1).length>0}for(const n of $a){const i=t,r=i?0:1;n.material.opacity+=(r-n.material.opacity)*(1-Math.exp(-s*14)),n.castShadow=!i}if(k){const n=Sh(k.position),i=qe==="intro"||qe==="playing"&&ue?.phase!=="crouch"&&(at.has("KeyW")||at.has("ArrowUp")||at.has("KeyS")||at.has("ArrowDown"));Lt.update(qe==="transition"?"playing":qe,er,i,st<.05&&ue?.phase!=="air",n,k.position,Gn)}Pn.render(vt,ft)}Pn.setAnimationLoop(qx);window.addEventListener("resize",()=>{ft.aspect=innerWidth/innerHeight,ft.updateProjectionMatrix(),Pn.setSize(innerWidth,innerHeight)});
